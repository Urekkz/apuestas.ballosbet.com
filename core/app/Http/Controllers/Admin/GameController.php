...
class GameController extends Controller {
    ...
    public function closedForBetting() {
        $this->pageTitle = 'Closed for Betting - Games';
    ...
    public function store(Request $request, $id = 0) {
        ...
        // 👇 NUEVO CAMPO: Guardar límite de tiempo de apuestas
        $game->bet_time_limit = $request->bet_time_limit ?? 10;
        
        // 👇 CAMPO DE ANUNCIO
        $game->announcement = $request->announcement;
    ...
    protected function validation($request) {
        $request->validate([
            ...
            // 👇 Validación agregada
            'bet_time_limit'  => 'nullable|integer|min:1|max:300',
        ], [
