...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        // House Earnings
        $widget['totalHouseEarnings']    = HouseEarning::sum('commission_amount');
        $widget['todayHouseEarnings']    = HouseEarning::whereDate('created_at', today())->sum('commission_amount');
        $widget['monthHouseEarnings']    = HouseEarning::whereMonth('created_at', now()->month)
