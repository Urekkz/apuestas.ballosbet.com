...
class SiteController extends Controller {
    ...
    public function index($categorySlug = null, $leagueSlug = null) {
        ...
        return response()
            ->view('Template::home', compact('pageTitle', 'leagues', 'games', 'activeCategory', 'activeLeague'))
    ...
    public function markets($gameSlug) {
        ...
        return response()
            ->view('Template::markets', compact('pageTitle', 'game'))
            ->header('Cache-Control', 'no-cache, no-store, must-revalidate')
            ->header('Pragma', 'no-cache')
            ->header('Expires', '0');
    }
    ...
    public function getOdds($id) {
        ...
        return response()
            ->view('Template::partials.odds_by_market', compact('outcomes'))
            ->header('Cache-Control', 'no-cache, no-store, must-revalidate')
            ->header('Pragma', 'no-cache')
            ->header('Expires', '0');
    }
