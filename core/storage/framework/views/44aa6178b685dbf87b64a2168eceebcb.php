                ...
                <table class="table-responsive--sm custom--table table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('Ganancia Bruta'); ?></th>
                            <th><?php echo app('translator')->get('Comisión'); ?> (5%)</th>
                            <th><?php echo app('translator')->get('Recibirás'); ?></th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $bets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <?php
                                    $profit = $bet->return_amount - $bet->stake_amount;
                                    $commissionPercent = 5.00;
                                    $commissionAmount = $profit > 0 ? round($profit * ($commissionPercent / 100), 8) : 0;
                                    $finalPayout = $bet->return_amount - $commissionAmount;
                                ?>
                                
                                <td>
                                    <span style="color: #ffc107;"><?php echo e(showAmount($commissionAmount)); ?></span>
                                    <br>
                                    <small class="text-muted">(sobre ganancia)</small>
                                </td>
                                <td>
                                    <strong style="color: #28a745;"><?php echo e(showAmount($finalPayout)); ?></strong>
                                </td>
