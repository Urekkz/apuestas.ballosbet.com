...
<body>
    ...
    <?php if(auth()->guard()->check()): ?>
                        ...
                        <form id="betForm" action="<?php echo e(route('user.bet.place')); ?>" method="POST">
                            ...
                            <div style="background: #2d2d2d; padding: 18px; border-radius: 10px; margin-bottom: 15px; border: 1px solid #ff8a00;">
                                <div class="mb-2 pb-2" style="border-bottom: 1px solid #444;">
                                    <small style="color: #999; font-size: 0.8rem;">balance</small>
                                    <div class="d-flex align-items-center justify-content-between mt-1">
                                        ...
                                        <a href="<?php echo e(route('user.deposit.index')); ?>" class="btn btn--success btn-sm" style="background: #28a745; padding: 4px 10px; border-radius: 6px; font-size: 0.8rem; font-weight: 600;">
        ...
        <script>
            ...
            window.userBalance = <?php echo e(auth()->user()->balance); ?>;
        </script>
    ...
    <script>
        ...
        // Preferir usar una cuota/odds explícita si está disponible (establecida por la UI de apuesta)
        const returnEl = document.getElementById('betReturnAmount');
        if (!returnEl) return;

        if (typeof window.currentOdds !== 'undefined' && window.currentOdds !== null && Number(window.currentOdds) > 0) {
            const totalReturn = stake * Number(window.currentOdds);
            returnEl.textContent = showAmount(totalReturn, 2, true, false, true);
            return;
        }

        // Si no hay odds explícitas, caer al cálculo por "favoritismo" (compatibilidad hacia atrás)
...
<?php /**PATH /home3/dannygue/apuestas.ballosbet.com/core/resources/views/templates/basic/layouts/app.blade.php ENDPATH**/ ?>