...
<?php $__env->startSection('frontend'); ?>
    ...
    ?>
    <div class="login-page section" style="background-image: url(<?php echo e(asset('assets/images/frontend/register/fondo-registro.jpg')); ?>); background-size: cover; background-position: center center; background-repeat: no-repeat;">
        <div class="container">
