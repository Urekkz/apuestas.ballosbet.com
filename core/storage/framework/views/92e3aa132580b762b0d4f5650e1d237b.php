...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['marketType', 'game', 'betPlacedIds' => []]));
...
foreach (array_filter((['marketType', 'game', 'betPlacedIds' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="timer-section">
    <div class="timer-box">
        ...
        <div
            ...
            id="countdown-<?php echo e($game->id); ?>"
            data-remaining="<?php echo e($remainingSeconds); ?>"
            data-state="<?php echo e($timerState); ?>"
        >
...
<?php if(optional($market)->favoritismo_label): ?>
    <div class="favoritismo-box text-center mt-3" style="margin-left: 70px;">
        <span class="favoritismo-label"><?php echo e($market->favoritismo_label); ?></span>
    </div>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.odds-button','data' => ['outcome' => $outcomeOne,'marketIsLocked' => @$market->locked,'betPlacedIds' => $betPlacedIds,'label' => 'Izquierda']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['outcome' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($outcomeOne),'marketIsLocked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(@$market->locked),'betPlacedIds' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($betPlacedIds),'label' => 'Izquierda']); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginald71f8655bdaaebdbc1fa6cb0f7f551bd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald71f8655bdaaebdbc1fa6cb0f7f551bd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.odds-button','data' => ['outcome' => $outcomeTwo,'marketIsLocked' => @$market->locked,'betPlacedIds' => $betPlacedIds,'label' => 'Derecha']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.odds-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['outcome' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($outcomeTwo),'marketIsLocked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(@$market->locked),'betPlacedIds' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($betPlacedIds),'label' => 'Derecha']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald71f8655bdaaebdbc1fa6cb0f7f551bd)): ?>
<?php $attributes = $__attributesOriginald71f8655bdaaebdbc1fa6cb0f7f551bd; ?>
...
<div class="custom-modal" id="customModal-<?php echo e($game->id); ?>" style="display:none;">
...
<?php /**PATH /home3/dannygue/apuestas.ballosbet.com/core/resources/views/components/frontend/odds-list.blade.php ENDPATH**/ ?>