...
<div class="row">
    <div class="col-12">
        <div class="row gy-4">
            ...
            <div class="col-xxl-3 col-sm-6">
                <x-widget style="7" link="{{ route('admin.users.refereed.users', $user->id) }}" title="Referred" icon="las la-sitemap" value="{{ $totalReferred }}" bg="deep-purple" type="2" />
            </div>
            <div class="col-xxl-3 col-sm-6">
                <x-widget style="7" link="{{ route('admin.users.referral.commissions', $user->id) }}" title="Ref. Commission Received" icon="las la-percentage" value="{{ showAmount($totalReferralCom) }}" bg="teal" type="2" />
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="checkbox" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="ev" @checked($user->ev)>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="checkbox" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="sv" @checked($user->sv)>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="checkbox" data-bs-toggle="toggle" data-on="@lang('Enabled')" data-off="@lang('Disabled')" name="ts" @checked($user->ts)>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="checkbox" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="kv" @checked($user->kv == Status::KYC_VERIFIED)>
                            </div>
                        </div>
...
<div id="addSubModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.users.add.sub.balance', $user->id) }}" method="POST" class="balanceAddSub disableSubmission">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" name="amount" class="form-control" placeholder="@lang('Please provide a positive amount')" required>
                            <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>@lang('Remark')</label>
                        <textarea class="form-control" name="remark" rows="4" placeholder="@lang('Remark')" required></textarea>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.users.status', $user->id) }}" method="POST">
                ...
                <div class="modal-body">
                    @if ($user->status == Status::USER_ACTIVE)
                        <h6>@lang('If you ban this bettor, they will lose access to their dashboard.')</h6>
                        <div class="form-group">
                            <label>@lang('Reason')</label>
                            <textarea class="form-control" name="reason" rows="4" required></textarea>
                        </div>
                    @else
                        <p><strong>@lang('Ban reason was:')</strong></p>
                        <p>{{ $user->ban_reason }}</p>
                        <h5 class="text-center mt-3">@lang('Are you sure you want to unban this bettor?')</h5>
                    @endif
                </div>
                <div class="modal-footer">
                    @if ($user->status == Status::USER_ACTIVE)
