...
@section('panel')
    <div class="row gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.game.inplay') }}" title="In Play Games" icon="las la-play" value="{{ $widget['totalLiveGame'] }}" bg="red"/>
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.game.upcoming') }}" title="Upcoming Games" icon="las la-calendar" value="{{ $widget['totalUpcomingGame'] }}" bg="warning"/>
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.game.open.for.betting') }}" title="Open For Betting" icon="las la-check" value="{{ $widget['totalOpenForBettingGame'] }}" bg="success"/>
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.game.not.open.for.betting') }}" title="Not Open For Betting" icon="las la-pause" value="{{ $widget['totalNotOpenForBettingGame'] }}" bg="dark"/>
        </div>
                        ...
                        <div class="widget-card bg--success">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Total Retiros')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.bet.pending') }}" title="Pending Bet" icon="las la-pause-circle" value="{{ $widget['pendingBet'] }}" bg="warning" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ticket.pending') }}" title="Pending Support Tickets" icon="la la-ticket" value="{{ $widget['pendingTicket'] }}" bg="2" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.kyc.pending') }}" title="Pending KYC Verifications" icon="la la-users" value="{{ $widget['pendingKycVerifications'] }}" bg="5" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.outcomes.declare.pending') }}" title="Pending Outcomes" icon="la la-coins" value="{{ $widget['pendingOutcomes'] }}" bg="6" />
        </div>
    </div>
