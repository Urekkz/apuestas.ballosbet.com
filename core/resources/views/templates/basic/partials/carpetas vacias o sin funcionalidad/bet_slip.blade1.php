        ...
        <div class="betslip-righ">
            <div class="betslip__list-ratio">
                ...
                <div class="position-relative">
                    <span class="betslip-input-inner"style="color: white;">{{ __(gs('cur_text')) }}</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (value === 'custom') {
                const customValue = prompt("Ingresa el monto que deseas apostar:");
                if (customValue && !isNaN(customValue)) {
                    inputAmount.value = parseFloat(customValue);
                }
            } else {
                inputAmount.value = parseFloat(value);
            }

            // Simula evento de cambio si hay validaciones dinámicas
