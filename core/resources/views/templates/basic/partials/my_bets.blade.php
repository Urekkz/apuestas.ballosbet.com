                            ...
                            @foreach (@$betData->details ?? [] as $betDetail)
                                ...
                                <div class="bet-single">
                                    ...
                                    <div class="bet-single__selected-team mb-2">
                                        <span class="name">{{ str_replace(['mano a mano', 'Mano a mano', 'MANO A MANO'], 'Uno contra Uno', __(@$outcome->name)) }}</span>
                                    </div>
                        ...
                        <div class="bet-list-item__footer">
                            <div class="bet-single-info">
                                ...
                                <div class="bet-single-info__item" style="border-top: 1px dashed rgba(255,255,255,0.1); padding-top: 8px; margin-top: 8px;">
                                    <span class="label" style="color: #ffc107;">@lang('Comisión si ganas')</span>
                                    <span class="value" style="color: #ffc107;">-{{ showAmount($commissionAmount, exceptZeros: true) }} ({{ $commissionPercent }}%)</span>
                                </div>
                                <div class="bet-single-info__item">
                                    <span class="label" style="font-weight: bold; color: #28a745;">@lang('Recibirás si ganas')</span>
                                    <span class="value" style="font-weight: bold; color: #28a745;">{{ showAmount($finalPayout, exceptZeros: true) }}</span>
                                </div>
                            </div>
                        </div>
                    </li>
