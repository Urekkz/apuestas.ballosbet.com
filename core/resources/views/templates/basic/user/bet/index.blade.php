        ...
        <div class="col-12">
            ...
            <div class="table-responsive">
                <table class="table-responsive--sm custom--table table">
                    <thead>
                        <tr>
                            <th>@lang('No. Apuesta')</th>
                            <th>@lang('Tipo')</th>
                            <th>@lang('Apostado')</th>
                            <th>@lang('Ganancia Bruta')</th>
                            <th>@lang('Comisión') (5%)</th>
                            <th>@lang('Recibirás')</th>
                            <th>@lang('Estado')</th>
                    ...
                    <tbody>
                        @forelse ($bets as $bet)
                            <tr>
                                ...
                                <td>
                                    <span style="color: #ffc107;">{{ showAmount($commissionAmount) }}</span>
                                    <br>
                                    <small class="text-muted">(sobre ganancia)</small>
                                </td>
                                <td>
                                    <strong style="color: #28a745;">{{ showAmount($finalPayout) }}</strong>
                                </td>
