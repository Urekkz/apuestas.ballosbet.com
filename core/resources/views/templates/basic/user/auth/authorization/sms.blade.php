                                ...
                                <form class="submit-form" action="{{ route('user.verify.mobile') }}" method="POST">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                            <h5 class="login-form__title">@lang('Verificar Correo')</h5>
                                    ...
                                    <div class="mt-3">
                                        <p>
                                            @lang('If you don\'t get any code'), <span class="countdown-wrapper">@lang('Intentar luego') <span id="countdown" class="fw-bold">--</span> @lang('seconds')</span> <a href="{{ route('user.send.verify.code', 'sms') }}" class="try-again-link d-none"> @lang('Try again')</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
