...
class Bet extends Model {
     ...
     * We include the new matching/open fields so the controller can fill them safely.
     */
    protected $fillable = [
        'status',
        'is_open',
    ...
    public function matchedBet() {
        return $this->belongsTo(Bet::class, 'matched_bet_id');
    }
    ...
    public function scopeOpen($query) {
        return $query->where('is_open', true)->whereNull('matched_bet_id');
    }
