    ...
    public function win()
    {
        ...
        try {
            ...
            foreach ($bets as $bet) {
                ...
                // monto a pagar: usamos return_amount, si viene en 0 usamos stake
                $payout = $bet->return_amount > 0 ? $bet->return_amount : $bet->stake_amount;

                DB::transaction(function () use ($bet, $payout) {
                    $user = $bet->user;
                    ...
                    // comisión por referido (si aplica)
