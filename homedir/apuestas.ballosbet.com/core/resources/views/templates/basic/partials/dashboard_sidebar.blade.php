<div class="dashboard-sidebar">
    <div class="widget-card widget-card--primary">
        ...
        <div class="widget-card__body">
            ...
            <span class="widget-card__balance-text">@lang('Saldo Actual')</span>
            <div class="d-flex gap-2">
                <a class="btn widget-card__withdraw flex-shrink-0 flex-grow-1" href="{{ route('user.withdraw') }}"> <i class="fa fa-minus"></i> @lang('Retirar')</a>
                <a class="btn widget-card__deposit flex-shrink-0 flex-grow-1" href="{{ route('user.deposit.index') }}"> <i class="fa fa-plus"></i> @lang('Depositar')</a>
            </div>
        </div>
    </div>
            ...
            <ul class="list dashboard-menu__list">
                <li>
                    <a class="dashboard-menu__link {{ menuActive('user.home') }}" href="{{ route('user.home') }}">
                        ...
                        <span class="dashboard-menu__text"> @lang('Tablero') </span>
                    </a>
                </li>
                ...
                <li>
                    <a class="dashboard-menu__link {{ menuActive('user.bets.*') }}" href="{{ route('user.bets.all') }}">
                        ...
                        <span class="dashboard-menu__text"> @lang('Mis Apuestas') </span>
                    </a>
                </li>
                ...
                <li>
                    <a class="dashboard-menu__link {{ menuActive('user.deposit.history') }}" href="{{ route('user.deposit.history') }}">
                        ...
                        <span class="dashboard-menu__text"> @lang('Historial de Deposito') </span>
                    </a>
                </li>
                ...
                <li>
                    <a class="dashboard-menu__link {{ menuActive('user.withdraw.history') }}" href="{{ route('user.withdraw.history') }}">
                        ...
                        <span class="dashboard-menu__text"> @lang('Historial de Retiro') </span>
                    </a>
                </li>
                ...
                @if (gs('referral_program'))
                    <li>
                        <a class="dashboard-menu__link {{ menuActive('user.referral.commissions') }}" href="{{ route('user.referral.commissions') }}">
                            ...
                            <span class="dashboard-menu__text"> @lang('Comisiones por Referidos') </span>
                        </a>
                    </li>
                @endif
                ...
                <li>
                    <a class="dashboard-menu__link {{ menuActive('user.transactions') }}" href="{{ route('user.transactions') }}">
                        ...
                        <span class="dashboard-menu__text"> @lang('Transacciones') </span>
                    </a>
                </li>
                ...
                <li>
                    <a class="dashboard-menu__link {{ menuActive('ticket.*') }}" href="{{ route('ticket.index') }}">
                        ...
                        <span class="dashboard-menu__text">@lang('Boletos de Soporte')</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="dashboard-menu__link" href="{{ route('user.logout') }}">
                        ...
                        <span class="dashboard-menu__text"> @lang('Cerrar Sesion') </span>
                    </a>
                </li>
            </ul>
        </div>
