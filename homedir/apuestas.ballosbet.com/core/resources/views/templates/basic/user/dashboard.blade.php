            ...
            <div class="row gy-4">
                <div class="col-xl-8">
                    <div class="d-flex gap-2 justify-content-between align-items-center mb-3">
                        <h5 class="m-0">@lang('Tabla de apuestas')</h5>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="qr-code text--base mb-1 mt-3">
                                <div class="qr-code-copy-form" data-copy=true>
                                    ...
                                    <button class="text-copy-btn copy-btn lh-1 text-white" data-bs-toggle="tooltip" data-bs-original-title="@lang('Copy to clipboard')" type="button">@lang('Copiar')</button>
                                </div>
                            </div>

                            <small class="lh-1 text-muted">
                                <i class="la la-info-circle"></i>
                                @lang('¡Gana una bonificación por recomendar a tus amigos! Solo tienes que compartir tu enlace de referido con ellos para empezar.')
                            </small>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-xl-4">
                    <h5 class="mt-0">@lang('Últimas Transacciones')</h5>
                    <div class="card">
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                @empty
                                    <li class="list-group-item text-center px-0">
                                        <small class="text-muted">@lang('Aún no hay transacciones')</small>
                                    </li>
                                @endforelse
                            </ul>
                        </div>
