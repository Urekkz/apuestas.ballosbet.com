    ...
    <div class="card custom--card">
        <div class="card-body">
            ...
            <form role="form" class="disableSubmission appPayment" id="payment-form" method="{{ $data->method }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label class="form-label">@lang('Numero de tarjera')</label>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <label class="form-label">@lang('Fecha de Expiracion')</label>
                ...
                <br>
                <button class="btn btn--base w-100" type="submit"> @lang('Enviar')</button>
            </form>
        </div>
    </div>
@endsection
