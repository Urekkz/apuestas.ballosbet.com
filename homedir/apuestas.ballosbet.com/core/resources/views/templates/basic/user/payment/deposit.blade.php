                        ...
                        <div class="payment-system-list p-3">
                            <div class="deposit-info">
                                <div class="deposit-info__title">
                                    <p class="text mb-0 fw-bold">@lang('Monto')</p>
                                </div>
                            ...
                            <div class="deposit-info">
                                <div class="deposit-info__title">
                                    <p class="text has-icon"> @lang('Limite')
                                        <span></span>
                                    </p>
                                </div>
                                <div class="deposit-info__input">
                            ...
                            <div class="deposit-info">
                                <div class="deposit-info__title">
                                    <p class="text has-icon">@lang('Cargo')
                            ...
                            <div class="d-none crypto-message mb-3">
                                @lang('Conversión con') <span class="gateway-currency"></span> @lang('and final value will Show on next step')
                            </div>

                            <button type="submit" class="btn btn--base w-100" disabled>
                                @lang('Confirmar Deposito')
                            </button>

                            <div class="info-text pt-3">
                                <p class="text">@lang('Garantizamos el crecimiento seguro de sus fondos mediante nuestro proceso de depósito seguro con resultados de pago de primera clase.')</p>
                            </div>
                        </div>
                    </div>
                </div>
