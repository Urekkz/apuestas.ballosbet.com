                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">@lang('Nombre en la tarjeta')</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">@lang('Numero de tarjeta')</label>
                            <div class="input-group">
