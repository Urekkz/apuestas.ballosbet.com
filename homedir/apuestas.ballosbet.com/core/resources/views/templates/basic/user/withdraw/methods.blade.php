                            ...
                            <div class="payment-system-list p-3">
                                <div class="deposit-info">
                                    <div class="deposit-info__title">
                                        <p class="text mb-0">@lang('Monto')</p>
                                    </div>
                                ...
                                <div class="deposit-info">
                                    <div class="deposit-info__title">
                                        <p class="text has-icon"> @lang('Limite')</p>
                                    </div>
                                    <div class="deposit-info__input">
                                ...
                                <div class="deposit-info total-amount pt-3">
                                    <div class="deposit-info__title">
                                        <p class="text">@lang('Saldo a retirar')</p>
                                    </div>
                                    <div class="deposit-info__input">
                                ...
                                <div class="info-text pt-3">
                                    <p class="text">@lang('Retira tus fondos de forma segura utilizando nuestro proceso altamente seguro y nuestros diversos métodos de retiro.')</p>
                                </div>
                            </div>
                        </div>
                    </div>
