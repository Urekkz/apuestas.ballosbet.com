        ...
        <ul class="list list--row primary-menu justify-content-end align-items-center right-side-nav gap-3 gap-sm-4">
            ...
            <li class="d-flex align-items-center">
                <?php if(auth()->guard()->check()): ?>
                    <div class="app-nav__menu-text text-white ps-2"><?php echo app('translator')->get('Balance'); ?>: <strong id="mobileBalance"><?php echo e(showAmount(auth()->user()->balance)); ?></strong></div>
                <?php endif; ?>
            </li>
