...
<div class="row g-4 justify-content-center align-items-center text-center">
    ...
    <div class="col-12">
        <nav class="footer-links d-flex justify-content-center flex-wrap">
            ...
            <a href="<?php echo e($contactUrl); ?>" class="footer-link">CONTACTO</a>
            <a href="<?php echo e($faqUrl); ?>" class="footer-link">PREGUNTAS FRECUENTES</a>
            <a href="<?php echo e($termsUrl); ?>" class="footer-link">TÉRMINOS Y CONDICIONES</a>
            <a href="<?php echo e($benefitsUrl); ?>" class="footer-link">BENEFICIOS</a>
        </nav>
    </div>
