...
<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper">
            <ul class="sidebar__menu">
                <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sideBarLinks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key): ?>
                        <li class="sidebar__menu-header"><?php echo e(__($key)); ?></li>
                    <?php endif; ?>
    ...
    <span class="text--primary" style="color: #ffffff !important;">BallosBet</span>
    <span class="text--success" style="color: #ff6600 !important;">Panel</span>
</div>
</div>
</div>
<!-- sidebar end -->
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home3/dannygue/apuestas.ballosbet.com/core/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>