...
- FIX: Escape attribute values before rendering in frontend (CCT filtering with " symbol)
- FIX: Properly handle escaped characters during filtering in meta query
